...
class Punycode
{
	...
	static function encode($d) {
		if (self::$instance === null) self::$instance = new Punycode();
		return self::$instance->doEncode($d);
	}
	static function decode($d) {
		if (self::$instance === null) self::$instance = new Punycode();
		return self::$instance->doDecode($d);
	}
	 ...
	 */
	public function doEncode($input)
	{
	 ...
	 */
	public function doDecode($input)
	{
