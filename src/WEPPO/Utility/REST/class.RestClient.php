...
class RestClient {
     ...
     */
    public function __construct( $url = null, $returnFormat = null, $userAgent = null, $options = array()  ) {
        if ( is_null( $url ) ) {
    ...
    public function setCredetials($u, $p) {
      $this->_user = $u;
      $this->_pass = $p;
    }
     ...
     * @return array
     */
    public function execute( $type, $path, $params = array(), $header = array(), $user = null, $pass = null ): RestResult {
        ...
        return new RestResult($this->_response);
    }
